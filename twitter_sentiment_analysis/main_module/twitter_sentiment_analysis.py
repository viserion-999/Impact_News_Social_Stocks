...
df_p1 = pd.read_csv("/Volumes/ANAGHA/Stock_prediction/Modules/twitter_sentiment_analysis/tatas_tweets_q1.csv")
df_p2 = pd.read_csv("/Volumes/ANAGHA/Stock_prediction/Modules/twitter_sentiment_analysis/tatas_tweets_q2.csv")
df_p3 = pd.read_csv("/Volumes/ANAGHA/Stock_prediction/Modules/twitter_sentiment_analysis/tatas_tweets_q3.csv")
...
#print('final dataframe info',df_twt.info())
...
#print("Info about final dataframe:",df_twt.info())
...
idx = pd.date_range('01-01-2018', '31-12-2018')
...
export_csv = df_twt.to_csv ("/Volumes/ANAGHA/Stock_prediction/Modules/twitter_sentiment_analysis/tatas_result.csv", header=True)
